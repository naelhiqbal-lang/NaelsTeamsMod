...
- Automatically assigns connected non-spectator players into teams by join order.
...
This is intentionally small and testable before adding deeper gameplay hooks such as lobby team UI, shared team balls, or friendly-fire rules.
